...
func (o *SearchTorrentsAsyncCancelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /torrent/search/{id}:cancel] searchTorrentsAsyncCancel", response, response.Code())
	}
}
...
func (o *SearchTorrentsAsyncCancelOK) Error() string {
	return fmt.Sprintf("[POST /torrent/search/{id}:cancel][%d] searchTorrentsAsyncCancelOK ", 200)
}
...
func (o *SearchTorrentsAsyncCancelNotFound) Error() string {
	return fmt.Sprintf("[POST /torrent/search/{id}:cancel][%d] searchTorrentsAsyncCancelNotFound ", 404)
}
...
func (o *SearchTorrentsAsyncCancelInternalServerError) Error() string {
	return fmt.Sprintf("[POST /torrent/search/{id}:cancel][%d] searchTorrentsAsyncCancelInternalServerError ", 500)
}
